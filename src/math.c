 ...
 * \param float x Para valor 1.
 * \param float y Para valor 2.
 * \return retorna 1 si se pudo realizar la división y (-1) en caso de que el dividendo sea igual a 0;
 *
 */
...
{
	if(CondicionAValidar!=1){ //CASO ERROR EN DIVISIÓN
